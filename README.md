...
(Add a link to your live demo here once published via GitHub pages!)
...
Simply include the fabric-warp-text.js file in your project after loading Fabric.js.
...
The shape of the warp (arch, bulge, flag, roof, valley).
...
The intensity of the effect. Negative values invert the effect.
...
The visual height mapping. Useful to control stretching independently from fontSize.
